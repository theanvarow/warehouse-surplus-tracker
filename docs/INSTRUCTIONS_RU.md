...
1. **QR-код на бейдже сотрудника:** Отсканируйте личный QR-код с бейджа (ФИО подставится автоматически). Ручной ввод с клавиатуры запрещен!
2. **Номер стола:** Отсканируйте штрих-код или QR-код на рабочем столе (например, `STOL-04`).
3. **Выберите смену:** Укажите смену (`1`, `2`, `3` или `4`).
4. **Автоматический вход:** После сканирования обоих кодов вход в систему произойдет мгновенно без нажатия кнопок.
