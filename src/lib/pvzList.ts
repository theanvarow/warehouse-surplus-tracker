...
const CITY_DICT: Record<string, { ru: string; uz: string; region: string }> = {
  ...
  'ХДЖ': { ru: 'Ходжаабад', uz: 'Xoʻjaobod', region: 'fergana' },
  'МИН': { ru: 'Миндон', uz: 'Mindon', region: 'fergana' },
  'СЛМ': { ru: 'Салом', uz: 'Salom', region: 'regions' },
  'БШК': { ru: 'Башкет', uz: 'Bashket', region: 'regions' },
  'ГЛС': { ru: 'Гулистан', uz: 'Guliston', region: 'regions' },
  'ЖЗК': { ru: 'Джизак', uz: 'Jizzax', region: 'regions' },
  'ХАК': { ru: 'Хаккулабад', uz: 'Haqqulobod', region: 'fergana' },
  'ЗХИ': { ru: 'Зарбдор', uz: 'Zarbdor', region: 'regions' },
  'ГБХ': { ru: 'Галабулок', uz: 'Gʻalabulon', region: 'regions' },
  'ЧРХ': { ru: 'Чирчик', uz: 'Chirchiq', region: 'tashkent' },
  'ХНЗ': { ru: 'Ханабад', uz: 'Xonobod', region: 'fergana' },
  'БЛА': { ru: 'Булакбаши', uz: 'Buloqboshi', region: 'fergana' },
  'ДЖР': { ru: 'Джаркурган', uz: 'Jarqoʻrgʻon', region: 'regions' },
  'ВХМ': { ru: 'Вабкент', uz: 'Vobkent', region: 'bukhara' },
  'БТН': { ru: 'Бустон', uz: 'Boʻston', region: 'regions' },
  'ЗИН': { ru: 'Зиёвуддин', uz: 'Ziyovuddin', region: 'samarkand' },
  'ШУР': { ru: 'Шурчи', uz: 'Shoʻrchi', region: 'regions' },
  'ХЖА': { ru: 'Хаджиабад', uz: 'Xoʻjaobod', region: 'fergana' },
  'ШКЛ': { ru: 'Шахрисабз', uz: 'Shahrisabz', region: 'regions' },
  'ЧНД': { ru: 'Чингельды', uz: 'Chingeldi', region: 'tashkent' },
  'БУР': { ru: 'Бурабай', uz: 'Boʻriboy', region: 'regions' },
  'БСН': { ru: 'Байсун', uz: 'Boysun', region: 'regions' },
  'БИР': { ru: 'Беруни', uz: 'Beruniy', region: 'regions' },
  'БУЛ': { ru: 'Булакбаши', uz: 'Buloqboshi', region: 'fergana' },
  'КИБ': { ru: 'Кибрай', uz: 'Qibray', region: 'tashkent' },
  'МНБ': { ru: 'Мингбулак', uz: 'Mingbuloq', region: 'fergana' },
  'ЭШН': { ru: 'Эшонгузар', uz: 'Eshonguzar', region: 'tashkent' },
  'ПТН': { ru: 'Пахтакор', uz: 'Paxtakor', region: 'regions' },
  'ГЛЛ': { ru: 'Галляарал', uz: 'Gʻallaorol', region: 'regions' },
  'ФЗБ': { ru: 'Файзабад', uz: 'Fayzobod', region: 'tashkent' },
  'ЧАН': { ru: 'Чартак', uz: 'Chortoq', region: 'fergana' },
  'АЛУ': { ru: 'Алтынкуль', uz: 'Oltinkoʻl', region: 'fergana' },
  'МГР': { ru: 'Мархамат', uz: 'Marhamat', region: 'fergana' },
  'ЯРТ': { ru: 'Янгирабат', uz: 'Yangirabot', region: 'bukhara' },
  'ДЖЛ': { ru: 'Джалакудук', uz: 'Jalaquduq', region: 'fergana' },
  'КВА': { ru: 'Кувасай', uz: 'Quvasoy', region: 'fergana' },
  'СОЙ': { ru: 'Сой', uz: 'Soy', region: 'regions' },
  'БКД': { ru: 'Бекабад', uz: 'Bekobod', region: 'tashkent' },
  'ДХД': { ru: 'Дехканабад', uz: 'Dehqonobod', region: 'regions' },
  'НМК': { ru: 'Наманган', uz: 'Namangan', region: 'fergana' },
  'ХСК': { ru: 'Ханка', uz: 'Xonqa', region: 'regions' },
  'КРС': { ru: 'Красногорск', uz: 'Krasnogorsk', region: 'tashkent' },
  'ПТГ': { ru: 'Пахтаабад', uz: 'Paxtaobod', region: 'fergana' },
  'УЗМ': { ru: 'Узун', uz: 'Uzun', region: 'regions' },
  'ЭШМ': { ru: 'Иштыхан', uz: 'Ishtixon', region: 'samarkand' },
  'БКБ': { ru: 'Балыкчи', uz: 'Baliqchi', region: 'fergana' },
  'ЗКТ': { ru: 'Зангиата', uz: 'Zangiota', region: 'tashkent' },
  'АКТ': { ru: 'Акташ', uz: 'Oqtosh', region: 'samarkand' },
  'ШРН': { ru: 'Ширин', uz: 'Shirin', region: 'regions' },
  'НВХ': { ru: 'Навбахор', uz: 'Navbahor', region: 'bukhara' },
  'ВБК': { ru: 'Вабкент', uz: 'Vobkent', region: 'bukhara' },
  'АСК': { ru: 'Асака', uz: 'Asaka', region: 'fergana' },
  'ГЖД': { ru: 'Гиждуван', uz: 'Gʻijduvon', region: 'bukhara' },
  'БУК': { ru: 'Бука', uz: 'Boʻka', region: 'tashkent' },
  'ККМ': { ru: 'Каракалпакстан', uz: 'Qoraqalpogʻiston', region: 'regions' },
  'ДШТ': { ru: 'Даштабад', uz: 'Dashtobod', region: 'regions' },
  'АМЧ': { ru: 'Амударья', uz: 'Amudaryo', region: 'regions' },
  'КИК': { ru: 'Кизиларик', uz: 'Qizilariq', region: 'regions' },
  'ЯКШ': { ru: 'Яккабаг', uz: 'Yakkabogʻ', region: 'regions' },
  'КУН': { ru: 'Кунград', uz: 'Qoʻngʻirot', region: 'regions' },
  'МРТ': { ru: 'Миришкор', uz: 'Mirishkor', region: 'regions' },
  'ПАП': { ru: 'Пап', uz: 'Pop', region: 'fergana' },
  'КНБ': { ru: 'Конимех', uz: 'Konimex', region: 'bukhara' },
  'ШЕР': { ru: 'Шерабад', uz: 'Sherobod', region: 'regions' },
  'КУЛ': { ru: 'Кула', uz: 'Qulo', region: 'regions' },
  'ЯТМ': { ru: 'Янгиташ', uz: 'Yangitosh', region: 'regions' },
  'НРД': { ru: 'Нурабад', uz: 'Nurobod', region: 'samarkand' },
  'УЧН': { ru: 'Учкудук', uz: 'Uchquduq', region: 'bukhara' },
  'НБД': { ru: 'Навабад', uz: 'Navobod', region: 'tashkent' },
  'БДЛ': { ru: 'Бахмал', uz: 'Baxmal', region: 'regions' },
  'КТШ': { ru: 'Куштепа', uz: 'Qoʻshtepa', region: 'fergana' },
  'АЛХ': { ru: 'Алтынсай', uz: 'Oltinsoy', region: 'regions' },
  'ТУК': { ru: 'Турткуль', uz: 'Toʻrtkoʻl', region: 'regions' },
