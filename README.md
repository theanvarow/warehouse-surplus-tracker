...
3. **📋 9 регламентных причин расхождений:**
...
4. **📊 Защищенный онлайн-мониторинг:**
   ...
   - **👥 Рейтинг выработки сотрудников:** детальные показатели по каждому оператору (товары, коробы, % доля в смене, стол, последнее время, медали 🥇🥈🥉).
   - Фильтр периода («☀️ Сегодня» / «📅 Все время») и моментальный поиск по ФИО.
